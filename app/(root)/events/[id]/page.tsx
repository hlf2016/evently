...
// params 中的 id 为动态路由参数 跟父目录的 [id] 相同
    ...
    <>
      <section className="flex justify-center bg-primary-50 bg-dotted-pattern bg-contain">
        <div className="grid grid-cols-1 md:grid-cols-2 2xl:max-w-7xl">
          {/* 这里引入的图片的地址 一定要在 next.config.js 的白名单中 且images.remotePatterns.pathname 要么指定值 要么不设置 不能为空 否则一直报错 TypeError: Expected a non-empty string */}
          <Image
            src={event.imageUrl}
            alt={event.title}
            width={1000}
